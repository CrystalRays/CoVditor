hljs.registerLanguage("solidity", (()=>{
    "use strict";
    function e() {
        try {
            return !0
    ...
    function r(e) {
        return e.inherit(e.APOS_STRING_MODE, {
            begin: /(\bunicode)?'/
        })
    }
    function l(e) {
        return e.inherit(e.QUOTE_STRING_MODE, {
            begin: /(\bunicode)?"/
        })
    }
    var o = {
    ...
    return e=>{
        for (var a = d(e), s = u(e), n = [], i = 0; i < 32; i++)
            n[i] = i + 1;
        var t = n.map((e=>8 * e))
          , r = [];
        for (i = 0; i <= 80; i++)
        ...
        var l = n.map((e=>"bytes" + e)).join(" ") + " "
          ...
          , E = t.map((e=>"int" + e)).join(" ") + " "
          , M = [].concat.apply([], t.map((e=>r.map((a=>e + "x" + a)))))
          , p = {
          ...
          , N = {
            ...
            lexemes: C,
            keywords: p,
            contains: [e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, a, s, b, "self"]
        }
          , f = {
            begin: /\.\s*/,
            end: /[^A-Za-z0-9$_\.]/,
        ...
        return {
            ...
            contains: [a, s, _, m, e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, b, w, O, {
                ...
                contains: [{
                    beginKeywords: "is",
                    lexemes: C
                }, y, N, w, e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE]
            }, {
                lexemes: C,
                ...
                contains: [e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, e.inherit(a, {
                    ...
                    endsParent: !0,
                    contains: v.contains.concat([e.inherit(v, {
                        begin: "{",
                        end: "}",
